    ...
    return (
        <div>
            ...
            <div className={classes.controls}>
                ...
                <IconButton color='primary' onClick={playPause} size='large'>
                    <Icon>
                        {playing
                            ? 'pause'
                            : values.ended
                ...
                <IconButton color='primary' onClick={toggleMuted} size='large'>
                    <Icon>
                ...
                >
                    <time
                        dateTime={`P${Math.round(duration * values.played)}S`}
                    >
